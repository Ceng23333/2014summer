...
function ParticleSystem() {
    ...
    function applyBound() {
        for (var i in particles)
            ChamberBox(0, 0, 400, 400, particles[i]);
    }
...
function step() {
    ps.emit(new Particle(new Vector2(200, 200), sampleDirection(Math.PI * 1.4, Math.PI * 1.6).multiply(1000), 3, sampleColor([1,0,0],[1,1,0]), 5));
    ps.simulate(dt);
